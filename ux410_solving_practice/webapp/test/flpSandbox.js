		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX410 문제_practice",
									"targetURL": "#sapbtpux410solvingpractice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpux410solvingpractice-display": {
								"semanticObject": "sapbtpux410solvingpractice",
								"action": "display",
								"description": "UX410 문제_practice",
								"title": "UX410 문제_practice",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.ux410solvingpractice",
									"url": sap.ui.require.toUrl("sap/btp/ux410solvingpractice")
								}
							}
						}
					}
