		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Program (09)",
									"targetURL": "#examexprogram09-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogram09-display": {
								"semanticObject": "examexprogram09",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogram09",
									"url": sap.ui.require.toUrl("exam/exprogram09")
								}
							}
						}
					}
