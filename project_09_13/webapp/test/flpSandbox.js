		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData CRUD",
									"targetURL": "#odataproject0913-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odataproject0913-display": {
								"semanticObject": "odataproject0913",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odata.project0913",
									"url": sap.ui.require.toUrl("odata/project0913")
								}
							}
						}
					}
