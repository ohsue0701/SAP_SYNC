		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX400 문제_practice",
									"targetURL": "#sapbtpux400solvingpractice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpux400solvingpractice-display": {
								"semanticObject": "sapbtpux400solvingpractice",
								"action": "display",
								"description": "UX400 문제_practice",
								"title": "UX400 문제_practice",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.ux400solvingpractice",
									"url": sap.ui.require.toUrl("sap/btp/ux400solvingpractice")
								}
							}
						}
					}
