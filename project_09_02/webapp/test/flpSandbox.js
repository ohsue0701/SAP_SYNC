		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Connection",
									"targetURL": "#syncproject0902-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncproject0902-display": {
								"semanticObject": "syncproject0902",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.project0902",
									"url": sap.ui.require.toUrl("sync/project0902")
								}
							}
						}
					}
